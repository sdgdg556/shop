...
$sql="select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.iPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName from products as p join cate c on p.cId=c.id {$where}  ";
...
$sql="select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.iPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName from products as p join cate c on p.cId=c.id {$where} {$orderBy} limit {$offset},{$pageSize}";
$rows=fetchAll($sql);
?>
<!doctype html>
<html>
            ...
            <tr>
                ...
                <td align="center">
                	...
                	<table class="table" cellspacing="0" cellpadding="0">
                		...
                		<tr>
                			<td  width="20%"  align="right">内部价格</td>
